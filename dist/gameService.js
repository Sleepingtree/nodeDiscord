...
exports.whoIs = exports.pickMap = exports.endGame = exports.checkMmr = exports.getTeamMessage = exports.startGame = void 0;
...
function startGame(bot, msg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (msg.content.includes("-manual")) {
            yield makeTeamsManual(bot);
        }
        else {
            console.log("in else");
            yield bot.channels.fetch(VOICE_CHANNEL_ID)
                .then(channel => {
                channel.members
                    .each(member => {
...
function moveUsers(bot, redTeamUser, blueteamUsers) {
    return __awaiter(this, void 0, void 0, function* () {
